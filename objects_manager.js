...
(function(MAETLibrary)
{
	...
	//TODO: Figure out how the hell levels are going to work
	...
	ObjectsManager.prototype.detectCollisions = function(game)
	{
		...
		function tempCollisionTest(thisObject)
		{
			...
			else if(game.objects_manager.enemy_objects.lastIndexOf(thisObject) !== -1) //Introducing O(N) here...REFACTOR DAMNIT!
			{
